...
| **Device**                | **Type**   | **How It Works**                                                                                                                          | **Key Characteristics / Uses**                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    |
| ------------------------- | ---------- | ----------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Monitor (VDU)**         | Visual     | Shows visual output from the computer’s video card.                                                                                       | **Types:** Digital (HDMI, DVI) give clearer signals; Analog (VGA) is older and less clear.<br><br>**Size:** Measured diagonally in inches.<br><br>**Resolution:** Number of pixels (for example, 1920×1080). More pixels mean a sharper image. <br><br>**Refresh Rate:** How many times the screen updates each second (measured in Hz). Higher rate = smoother motion. <br><br>**Interlaced / Non-Interlaced:** Non-interlaced (progressive scan) draws the whole image at once and is used today. Interlaced draws odd and even lines separately, which can cause flicker. <br><br>**Dot Pitch:** The distance between two pixels. Smaller dot pitch = sharper image.<br><br>**Video Standards:** VGA (640×480), SVGA (800×600), and XGA (1024×768) are older resolution types. |
| **Printers**              | Hard Copy  | Converts digital documents into physical form on paper.                                                                                   |                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
| **Daisy Wheel**           | Impact     | A wheel with raised letters (molds) spins. The correct letter hits the ink ribbon and prints on the paper.                                | **Use:** Early word processors.<br>**Features:** Very good text quality, but slow, noisy, and cannot print graphics. Now obsolete.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                |
| **Dot Matrix**            | Impact     | Has a print head with small pins that hit an ink ribbon to make characters from dots.                                                     | **Use:** Printing invoices and forms. <br>**Features:** Cheap, durable, can make carbon copies, but noisy and low-quality output.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |
| **Inkjet**                | Non-Impact | Sprays tiny drops of liquid ink onto paper to form text and images.                                                                       | **Use:** Home printing, photo printing. <br>**Features:** Good color quality, quiet, and low cost, but ink cartridges are expensive.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              |
| **Laser**                 | Non-Impact | A laser creates an electrostatic image on a rotating drum. Toner (powdered ink) sticks to the drum and is transferred to paper with heat. | **Use:** Offices and high-volume printing. <br>**Features:** Very fast, sharp text, and low cost per page.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
| **Line Printer**          | Impact     | Prints one full line of text at a time using a chain or band of characters.                                                               | **Use:** Data centers and bulk report printing. <br>**Features:** Extremely fast for text, but very loud and poor quality.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
| **Plotter**               | Hard Copy  | Uses pens or markers to draw continuous lines on paper from vector graphic commands.                                                      | **Use:** Making large drawings like maps, blueprints, and engineering designs. <br>**Features:** Very accurate and high-quality line drawings.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    |
| **Sound Card & Speakers** | Audio      | The sound card changes digital audio into analog signals. Speakers then turn those signals into sound waves.                              | **Use:** Playing music, games, video calls, and system alerts.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    |
# QUICK NOTES 
#### **1. Computer System Concepts**
